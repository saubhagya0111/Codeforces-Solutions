...
void solution()
{
    ...
    //Find the element which is the median of the given elements and then return the sum of the  absolute differences between the other two elements
    ll c;
    in3(a, b, c);
    vi v;
    v.pb(a);
    ...
    v.pb(c);
    sort_all(v);
    ll sum = abs(v[0] - v[1]) + abs(v[1] - v[2]);
    out(sum);
    line;
}
/************************************/
