...
#endif
/************************************/
int return_count_of_digits(int n)
{
    int c = 0;
    while (n > 0)
    {
...
void solution()
{
    ...
    vi v = {1, 11, 111, 1111, 2, 22, 222, 2222, 3, 33, 333, 3333, 4, 44, 444, 4444, 5, 55, 555, 5555, 6, 66, 666, 6666, 7, 77, 777, 7777, 8, 88, 888, 8888, 9, 99, 999, 9999};
    in(n);
    auto i1 = find(all(v), n);
    int index = i1 - v.begin();
    int sum = 0;
    incr_loop(0, index + 1)
    {
        sum += return_count_of_digits(v[i]);
    }
    out(sum);
    line;
    debug(index);
